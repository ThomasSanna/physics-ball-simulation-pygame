...
while running:
    ...
    draw_notification(screen, formatNombres(likes), WIDTH, HEIGHT, y=260, scale=1.0)
    # Affichage du texte "Like Piece of Chill!" en bas de l'écran avec fond blanc et écriture noire
    footer_font = pygame.font.SysFont(None, 16)
    footer_text = footer_font.render("Likes on this video:", True, (0, 0, 0))
    footer_rect = footer_text.get_rect(center=(WIDTH // 2, 240))

    # Fond blanc derrière le texte
    footer_bg = pygame.Surface((footer_rect.width + 20, footer_rect.height + 10))
    footer_bg.fill((255, 255, 255))
    footer_bg_rect = footer_bg.get_rect(center=footer_rect.center)
